...
#define TestAgent_hpp_16_init  bool _InitInternal() override \
{ \
...
#define TestAgent_hpp_16_initStatic static bool _InitStaticInternal()  \
{ \
...
public: \
	...
	{\
		...
		ms_event.reset(new ScEvent(*ms_context, Keynodes::question_testing_agent, ScEvent::Type::AddOutputEdge, &TestAgent::handler_emit));\
        if (ms_event.get())\
        {\
